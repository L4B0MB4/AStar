...
public class NodeFactory {
    ...
    /**
     * This function calculates and sets the distance between every node in a list
     * and a specific point. Distance is calulated by distance^2 =x^2 + y^2
     * 
    ...
    public static void setDistance(ArrayList<Node> nodes, Point end) {
        for (int i = 0; i < nodes.size(); i++) {
            ...
            nodes.get(i).setDistance(distance * HEURSITIC_FACTOR);
        }
    }
}